...
fetch("pagine.txt?cachebuster=37a6a1a3fb6045ccH").then((res) => res.text()).then((text) => {
        ...
        document.getElementsByTagName("body")[0].innerHTML += "<div class=header><img src=\"icona_tendina.png?cachebuster=f5e829a646c2f149H\"><div class=headcontent>".concat(full_text, "</div></div>");
