...
fetch("pagine.txt?cachebuster=cd2a0c85be08c9aaH").then((res) => res.text()).then((text) => {
        ...
        document.getElementsByTagName("body")[0].innerHTML += "<div class=header><img src=\"icona_tendina.png?cachebuster=d72d332e857a4257H\"><div class=headcontent>".concat(full_text, "</div></div>");
