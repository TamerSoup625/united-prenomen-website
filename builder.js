...
fetch("pagine.txt?n=7").then((res) => res.text()).then((text) => {
        ...
        document.getElementsByTagName("body")[0].innerHTML += "<div class=header><img src=\"icona_tendina.png?n=1\"><div class=headcontent>".concat(full_text, "</div></div>");
