...
fetch("pagine.txt?cachebuster=NEWHASH").then((res) => res.text()).then((text) => {
        ...
        document.getElementsByTagName("body")[0].innerHTML += "<div class=header><img src=\"icona_tendina.png?cachebuster=NEWHASH\"><div class=headcontent>".concat(full_text, "</div></div>");
